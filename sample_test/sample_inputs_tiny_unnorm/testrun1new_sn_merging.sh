...
cd sn_branch_unnorm
source ./cleandata
mpirun -np 2 /home/wonjae/ws/branchinESL/devel5Dopt4D_merging_unnorm/exec/cogent.Linux.64.mpicxx.gfortran.OPT.MPI.ex sn_loss_cone_ten_block.in |tee output.txt
cd ../

cd sn_trunk_unnorm
source ./cleandata
mpirun -np 2 /home/wonjae/ws/trunkESL/trunk_unnorm/exec/cogent.Linux.64.mpicxx.gfortran.OPT.MPI.ex sn_loss_cone_ten_block.in |tee output.txt
cd ../
...
h5diff sn_branch_unnorm/chk0010.4d.hdf5 sn_trunk_unnorm/chk0010.4d.hdf5 |tee -a sn_result.txt
echo "####h5diff sn_branch_unnorm vs sn_trunk_unnorm plt file" |tee -a sn_result.txt
h5diff sn_branch_unnorm/plt_density_plots/plt.1.hydrogen.density0010.2d.hdf5 sn_trunk_unnorm/plt_density_plots/plt.1.hydrogen.density0010.2d.hdf5 |tee -a sn_result.txt
echo "####h5diff sn_branch_unnorm vs sn_trunk_unnorm plt map file" |tee -a sn_result.txt
h5diff sn_branch_unnorm/plt_density_plots/plt.1.hydrogen.density0010.2d.map.hdf5 sn_trunk_unnorm/plt_density_plots/plt.1.hydrogen.density0010.2d.map.hdf5 |tee -a sn_result.txt
