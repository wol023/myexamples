...
source ./cleandata
mpirun -np 2 /home/wonjae/ws/branchinESL/devel5Dopt4D_merging_unnorm/exec/cogent.Linux.64.mpicxx.gfortran.OPT.MPI.ex gam.in |tee output.txt
cd ../

cd gam_trunk_unnorm
source ./cleandata
mpirun -np 2 /home/wonjae/ws/trunkESL/trunk_unnorm/exec/cogent.Linux.64.mpicxx.gfortran.OPT.MPI.ex gam.in |tee output.txt
cd ../
