...
h5diff $DIR_UNNORM/$TR_UN/plt_density_plots/plt.density0010.1.hydrogen.2d.hdf5 $DIR_RENORM/$TR_RE/plt_density_plots/plt.density0010.1.hydrogen.2d.hdf5 |tee -a $RESULT_FILE $TOTAL_RESULT_FILE
echo "####h5diff $TR_UN vs $TR_RE plt map file" |tee -a $RESULT_FILE $TOTAL_RESULT_FILE
h5diff $DIR_UNNORM/$TR_UN/plt_density_plots/plt.density0010.1.hydrogen.2d.map.hdf5 $DIR_RENORM/$TR_RE/plt_density_plots/plt.density0010.1.hydrogen.2d.map.hdf5 |tee -a $RESULT_FILE $TOTAL_RESULT_FILE
...
echo "####h5diff $TR_UN vs $TR_RE plt file" |tee -a $RESULT_FILE $TOTAL_RESULT_FILE
h5diff $DIR_UNNORM/$TR_UN/plt_density_plots/plt.density0005.1.hydrogen.2d.hdf5 $DIR_RENORM/$TR_RE/plt_density_plots/plt.density0005.1.hydrogen.2d.hdf5 |tee -a $RESULT_FILE $TOTAL_RESULT_FILE
echo "####h5diff $TR_UN vs $TR_RE plt map file" |tee -a $RESULT_FILE $TOTAL_RESULT_FILE
h5diff $DIR_UNNORM/$TR_UN/plt_density_plots/plt.density0005.1.hydrogen.2d.map.hdf5 $DIR_RENORM/$TR_RE/plt_density_plots/plt.density0005.1.hydrogen.2d.map.hdf5 |tee -a $RESULT_FILE $TOTAL_RESULT_FILE
echo "####" |tee -a $RESULT_FILE $TOTAL_RESULT_FILE
