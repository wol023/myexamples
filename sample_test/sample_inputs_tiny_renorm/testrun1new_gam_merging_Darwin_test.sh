...
mpirun -np 2 /Users/wonjae/ws/testdir_branch/devel5Ddbg5D_4D/exec/cogent.Darwin.64.mpicxx.gfortran.OPT.MPI.ex gam.in |tee output.txt
cd ../

cd gam_trunk_renorm
source ./cleandata
#mpirun -np 2 /home/wonjae/ws/trunkESL/trunk_renorm/exec/cogent.Linux.64.mpicxx.gfortran.OPT.MPI.ex gam.in |tee output.txt
mpirun -np 2 /Users/wonjae/ws/testdir/trunk/exec/cogent.Darwin.64.mpicxx.gfortran.OPT.MPI.ex gam.in |tee output.txt
cd ../
