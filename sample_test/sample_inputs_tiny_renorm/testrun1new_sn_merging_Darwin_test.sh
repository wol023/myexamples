...
mpirun -np 2 /Users/wonjae/ws/testdir_branch/devel5Ddbg5D_4D/exec/cogent.Darwin.64.mpicxx.gfortran.OPT.MPI.ex sn_loss_cone_ten_block.in |tee output.txt
cd ../
...
mpirun -np 2 /Users/wonjae/ws/testdir/trunk/exec/cogent.Darwin.64.mpicxx.gfortran.OPT.MPI.ex sn_loss_cone_ten_block.in |tee output.txt
cd ../
...
h5diff sn_branch_renorm/chk0005.4d.hdf5 sn_trunk_renorm/chk0005.4d.hdf5 |tee -a sn_result.txt
echo "####h5diff sn_branch_renorm vs sn_trunk_renorm plt file" |tee -a sn_result.txt
h5diff sn_branch_renorm/plt_density_plots/plt.1.hydrogen.density0005.2d.hdf5 sn_trunk_renorm/plt_density_plots/plt.1.hydrogen.density0005.2d.hdf5 |tee -a sn_result.txt
echo "####h5diff sn_branch_renorm vs sn_trunk_renorm plt map file" |tee -a sn_result.txt
h5diff sn_branch_renorm/plt_density_plots/plt.1.hydrogen.density0005.2d.map.hdf5 sn_trunk_renorm/plt_density_plots/plt.1.hydrogen.density0005.2d.map.hdf5 |tee -a sn_result.txt
