...
source ./cleandata
mpirun -np 2 /Users/wonjae/ws/testdir_branch/devel5Ddbg5D_4D/exec/cogent.Darwin.64.mpicxx.gfortran.OPT.MPI.ex neoclass_lin.in |tee output.txt
#mpirun -np 2 /Users/wonjae/ws/branchinESL/devel5Ddbg5D_merging_4D/exec/cogent.Darwin.64.mpicxx.gfortran.OPT.MPI.ex neoclass_lin.in |tee output.txt
...
source ./cleandata
mpirun -np 2 /Users/wonjae/ws/testdir/trunk/exec/cogent.Darwin.64.mpicxx.gfortran.OPT.MPI.ex neoclass_lin.in |tee output.txt
