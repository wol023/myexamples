...
## 2. Perform FFT on raw signal
## 3. Linear squre fit to optimize freq, phase, constant, amplitude :fix growth rate
## 4. Perform FFT on reconstructed signal 
## 3. Linear squre fit to optimize phase, growth, freq, mean : fix amplitude
...
#est_freq, est_phase, est_mean, est_amplitude 
...
print 'refine_est_grow. = ',refine_est_growth

legend_data_fit_with_growth = r'$\gamma/\omega^*, \gamma_r/\omega^*$'+' = (%g, %g)'% ( est_growth/omega_star_point, refine_est_growth/omega_star_point)+'\n'+r'$\gamma/\omega^*, \gamma_r/\omega^*$'+' = (%g, %g)'% ( est_growth/omega_star_analytic, refine_est_growth/omega_star_analytic)
init_plotting()
plt.subplot(111)
plt.gca().margins(0.1, 0.1)
#plt.plot(dimensional_xt,y,marker='.',linestyle='-',linewidth=1,color='b',label='potential' )
